...
const BorrowService = __importStar(require("../services/borrow.service"));
const borrowBook = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const borrowRecord = yield BorrowService.borrowBook(req.body);
        res.status(201).json({
            success: true,
...
const getBorrowedBooksSummary = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const summary = yield BorrowService.getBorrowedBooksSummary();
        res.status(200).json({
            success: true,
